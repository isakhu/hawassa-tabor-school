...
function LoginContent() {
  ...
  return (
    ...
    >
      <div
        style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "40px", position: "relative", borderRight: "1px solid rgba(99,102,241,0.12)" }}
        ...
        <div style={{ width: "100%", maxWidth: 420 }}>
          ...
          <div className="glass-card animate-pulse-glow" style={{ padding: "36px 32px" }}>
            <div style={{ textAlign: "center", marginBottom: 28 }}>
              <div style={{ display: "flex", justifyContent: "center", marginBottom: 16 }}><LogoMark size={44} /></div>
            ...
            {registered && (
              <div style={{ marginBottom: 20, padding: "12px 16px", background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.3)", borderRadius: 10, fontSize: 14, color: "#6ee7b7", display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                ...
                <input type="password" required autoComplete="current-password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} className="input-glow" style={inputStyle} />
              </div>
            ...
            <p style={{ marginTop: 20, textAlign: "center", fontSize: 14, color: "#6b6b80" }}>
              ...
              <Link href="/register" style={{ background: "linear-gradient(135deg, #6366f1, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", fontWeight: 600, textDecoration: "none" }}>
                Create one
              </Link>
            </p>
          </div>
