...
async def seed_admin():
    ...
    async with AsyncSessionLocal() as session:
        ...
        if existing_admin:
            ...
            return
        session.add(User(full_name=settings.ADMIN_FULL_NAME, email=settings.ADMIN_EMAIL,
            ...
            for section_letter in config["sections"]:
                ...
                for i in range(1, config["per_section"] + 1):
                    ...
                    for class_id, teacher_user_id in section_info:
                        ...
                        grade_records.append(Grade(student_id=student.id, class_id=class_id, graded_by=teacher_user_id, assessment_type=AssessmentType.EXAM, term="Term 1", score=score, max_score=100, grade_letter=calculate_grade_letter(score), comments="Automatic demo seed"))
